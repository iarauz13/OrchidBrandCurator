...
admin.initializeApp();
// Gen 2 Configuration
(0, v2_1.setGlobalOptions)({ maxInstances: 10, memory: "2GiB", timeoutSeconds: 300 });
exports.enrichNewStore = (0, firestore_1.onDocumentCreated)("collections/{collectionId}/stores/{storeId}", async (event) => {
    ...
    try {
        // 3. Execution: Scrape
        const metadata = await (0, scraper_1.scrapeStore)(url);
